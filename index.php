  ...
  <body>
    ...
    <div class="container">
        ...
        if(isset($_POST['search'])){
          ...
          $sql = mysqli_query($conn, "SELECT * FROM all_jobs LEFT JOIN company ON all_jobs.customer_email = company.admin WHERE keyword LIKE '%$keyword%' OR category LIKE '$category'");
            ...
            <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="mb-4 mb-md-0 mr-5">
                ...
                <div class="job-post-item-body d-block d-md-flex">
                  ...
                  <div><span class="icon-my_location"></span> <span><?php echo $row['state'];?>, <?php echo $row['city'];?></span></div>
                </div>
              </div>
