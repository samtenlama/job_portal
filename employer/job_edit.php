    ...
    <div style="width: 60%; margin-left: 20%; background-color: #E5E8E8;">
        ...
        <form action="" method="post" style="margin:3%; padding: 3%;" name="job_form" id="job_form">
            ...
            <div class="form-group">
                ...
                <input type="number" name="salary" id="salaryId" class="form-control" value="<?php echo $salary; ?>">
            </div>
...
if (isset($_POST['submit'])) {
    ...
    $query1 = mysqli_query($conn, "update all_jobs set job_title='$job_title,',des='$Description',country='$country',state='$state',city='$City', salary='$salary', qualification='$qualification', job_status='$status' where job_id ='$id'");
    if ($query1) {
        echo "<script>alert('Record has been Update succcessfuly  !!!!')</script>";
