            ...
            <div style="padding: 2%;">
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <input type="number" class="form-control" name="number" id="number" value="<?php echo $number; ?>">
                </div>
                <div class="col-sm-6">
              ...
              <input type="submit" name="submit" value="Submit Application" placeholder="Submit"
