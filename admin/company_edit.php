                ...
                <div style="width: 60%; margin-left: 20%; background-color: #E5E8E8;">
                    ...
                    <div id="msg"></div>
                        <div class="form-group">
                            ...
                            <input type="Company" name="Company" id="Company" value="<?php echo $company_name; ?>" class="form-control" placeholder="Enter company_name">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-group">
                            <label for="Customer Username">Select Comapany Admin</label>
